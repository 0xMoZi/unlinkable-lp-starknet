...
use contract::verifier::honk_verifier::{
...
#[test]
//#[fork(url: "<YOUR RPC>", block_tag: latest)]
fn test_verify_ultra_keccak_zk_honk_proof() {
    ...
    assert(public_inputs.len() >= 1, 'No public inputs');
    assert(0x1caae7c271a415ff196388436669fc10b6a1c3da2055313c12701f5ce65306e7 == *public_inputs.at(0), 'N/A');
